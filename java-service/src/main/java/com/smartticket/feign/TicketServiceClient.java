...
public interface TicketServiceClient {
     ...
     */
    @PostMapping(value = "/api/v1/tickets/urgent", consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     */
    @PostMapping(value = "/api/v1/orders/cancel", consumes = MediaType.APPLICATION_JSON_VALUE)
